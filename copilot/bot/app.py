...
COMMANDS = {
    ...
    "oi": commands.oi_cmd, "ls": commands.ls_cmd,
    ...
    "news": commands.news_cmd, "heat": commands.heat,
    "hot": commands.hot, "read": commands.read_cmd,
    "long": commands.long_cmd, "short": commands.short_cmd, "close": commands.close,
...
JOBS = [
    ...
    (alerts.poll_positions, config.POSITIONS_INTERVAL, 50),
    (alerts.poll_news, config.NEWS_INTERVAL, 60),
    (alerts.poll_scan, config.SCAN_INTERVAL, 75),
    (alerts.poll_open_interest, config.OI_INTERVAL, 90),
    (alerts.poll_liquidations, config.LIQ_INTERVAL, 105),
    (alerts.poll_fng, config.FNG_INTERVAL, 120),
    (alerts.poll_long_short, config.LS_INTERVAL, 135),
